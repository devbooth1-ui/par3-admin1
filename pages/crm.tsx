...
export default function CRM() {
  ...
  const [courseManager, setCourseManager] = useState(course?.manager || "");
                      ...
                      <div className="overflow-x-auto">
                          <table className="min-w-full divide-y divide-gray-200">
                              ...
                              <tbody className="bg-white divide-y divide-gray-200">
                                  ...
                                  {/* Show editable notes/manager field for course */}
                                  {editingCourse && course && (
                                      <tr className="bg-blue-50">
                                        <td colSpan={7} className="px-6 py-4">
                                          <div className="mb-2 font-semibold">Course Manager:</div>
                                          <input
                                            className="w-full p-2 border rounded mb-2"
                                            value={courseManager}
                                            onChange={e => setCourseManager(e.target.value)}
                                          ...
                                          <div className="flex gap-2 mt-2">
                                            <button className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700" onClick={saveCourseDetails}>Save</button>
